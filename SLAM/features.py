...
class freaturesDetection:
    ...
    # distance point to line written inthe general form
    ...
    # define a function (quadratic in our case) to for the data with,
    ...
    def seed_segment_growing( self,  indices, break_point ):
        ...
        i, j = indices
        # Begining and Final ponts in the line segment

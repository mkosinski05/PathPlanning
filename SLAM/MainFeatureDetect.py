from SLAM import env, sensors, features
import pygame
import math
import random
...
FeatureMAP=features.freaturesDetection()
environment = env.buildEnvironment((667, 1024))
    ...
    if sensorON :
        ...
        while BREAK_POINT_IND < ( FeatureMAP.NP - FeatureMAP.PMIN):
            ...
            if seedSeg == False:
                ...
                INDICIES=seedSeg[2]
                results=FeatureMAP.seed_segment_growing(INDICIES, BREAK_POINT_IND)

                if results == False:
                    BREAK_POINT_IND=INDICIES[1]
                    continue
                else:
